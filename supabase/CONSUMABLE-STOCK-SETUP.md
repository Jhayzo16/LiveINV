...
2. Add or edit a System Unit. Choose the RAM stock source and/or SSD stock source, and enter the installed quantity for each. Each type uses one receipt source, matching the existing per-module/per-drive capacity fields.
